...
logger = LoggingHandler(f"{prop().get_result_log_file_path()}FDSRandomForestClassifier", "a", "DEBUG")
...
class FDSRandomForestClassifier(FDSModel):
    ...
    def __init__(self, data: SparkDataObject):
        super(FDSRandomForestClassifier, self).__init__(logger.get_log(), data)
